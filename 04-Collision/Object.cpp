...
*/
LPCOLLISIONEVENT2 Object::SweptAABBEx(LPGAMEOBJECT2 coO)
{
...
void Object::CalcPotentialCollisions(
	vector<LPGAMEOBJECT2> *coObjects,
	vector<LPCOLLISIONEVENT2> &coEvents)
{
	for (UINT i = 0; i < coObjects->size(); i++)
	{
		LPCOLLISIONEVENT2 e = SweptAABBEx(coObjects->at(i));
	...
	float &nx, float &ny) // Hàm này sẽ lấy ra sự kiện va chạm đến sớm nhất trên mỗi trục x , y
{
	...
	{
		LPCOLLISIONEVENT2 c = coEvents[i];
